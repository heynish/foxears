...
export async function overlayImages(baseImagePath: string, overlayImagePath: string, outputFileName: string, options: OverlayOptions = {}): Promise<string> {
  ...
  await faceapi.nets.tinyFaceDetector.loadFromDisk('https://mframes.vercel.app/models/');
  await faceapi.nets.faceLandmark68Net.loadFromDisk('https://mframes.vercel.app/models/');
